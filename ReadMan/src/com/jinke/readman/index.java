...
//				WindowManager.LayoutParams.FLAG_FULLSCREEN);  
		...
		mUrlHash = new UrlHash(index.this);
		
		mprogressBar = (ProgressBar)findViewById(R.id.index_progress_bar);
		indexWV = (mWebView)findViewById(R.id.indexWV);
	 ...
	 public boolean onKeyDown(int keyCode, KeyEvent event) {//捕捉返回键
			...
			public void ConfirmExit(){//退出确认
				AlertDialog.Builder ad=new AlertDialog.Builder(index.this);
				ad.setTitle("退出");
	...
	private void gotoRSS(){
		...
		mIntent.setClass(index.this, flipper.class);
