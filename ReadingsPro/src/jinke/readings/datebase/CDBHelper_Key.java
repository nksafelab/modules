...
public class CDBHelper_Key extends SQLiteOpenHelper{
	...
	public CDBHelper_Key(Context context, String name, CursorFactory factory,
			int version) {
	...
	public CDBHelper_Key(Context context, String name) {
		super(context, name, null, DATEBASE_VERSION);
		// TODO Auto-generated constructor stub
	}
	public CDBHelper_Key(Context context) {
