...
*@tags:
 */
public class CopyOfWorkspace extends ViewGroup {
     ...
     */
    public CopyOfWorkspace(Context context, AttributeSet attrs) {
     ...
     */
    public CopyOfWorkspace(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        
//        TypedArray a = context.obtainStyledAttributes(attrs, com.girlcoding.www.R.styleable.Workspace, defStyle, 0);
        mDefaultScreen = 0;
//        a.recycle();
